...
public class GpsFallEng extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void myNotification() {
        ...
        Intent intent = new Intent(GpsFallEng.this, AlertNotificationEng.class);

        PendingIntent pendingIntent = PendingIntent.getActivity(GpsFallEng.this,
                (int) System.currentTimeMillis(), intent, 0);

        Uri uri = RingtoneManager.getDefaultUri(Notification.DEFAULT_SOUND);

        Notification.Builder builder = new Notification.Builder(GpsFallEng.this);
        builder.setTicker("We almost there");
        builder.setContentTitle("Near " + nameFallString);
        builder.setContentText("In 500m. to reach the waterfall.");
